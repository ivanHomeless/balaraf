...
<div class="card">
    <div class="card-header py-3">
        <a href="{{route('admin.cards.create', ['lang' => $lang->id])}}" type="button" class="btn add-item btn-primary px-5">Добавить</a>
    </div>
    <div class="card-body">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-3 fs-6">
                            ...
                            <form id="destroy-form" action="{{route('admin.cards.destroy', $card->id)}}" method="POST" style="display: none;">
                                {{ method_field('delete') }}
                                {{ csrf_field() }}
                            </form>
